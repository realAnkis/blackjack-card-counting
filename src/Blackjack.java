...
public class Blackjack {
    ...
    public static void main(String[] args,boolean printGameStatus, BiFunction<int[], ArrayList<Integer>, String> actionMethod, BiFunction<int[], ArrayList<Integer>, Integer> betMethod, BiFunction<int[], ArrayList<Integer>, Integer> insuranceBetMethod, Consumer<Integer[]> dealCardMethod) {
        ...
        for (int game = 0; game < numberOfGames; game++) {
            ...
            if (total[1] == 11) {
                if(printGameStatus) print(allowedActions);
            ...
            if (total[1] + cardValue(dealer2ndCard) == 21) {
                ...
                } else if(printGameStatus) System.out.println("Dealer has blackjack!");
                pengar += insuranceBet * 2;
                if(printGameStatus) System.out.println("+" + insuranceBet * 2 + "kr from insurance bet");
                continue;
            }
            ...
            if (total[0] == 21) {
                if(printGameStatus) System.out.println("Player has blackjack! +" + (int) (bet * 2.5) + "kr");
                pengar += (int) (bet * 2.5);
                continue;
            }
            ...
            if (printGameStatus && total[0] > 21) System.out.println("Player busted!");
            if (printGameStatus && total[2] > 21) System.out.println("Split busted!");
            ...
            if (playerFirstCards[0] >= 10 && hasAce[0] != 0 && total[0] == 21) {
                ...
                if (total[0] > total[1]) {
                    if(printGameStatus) System.out.println("Player wins! +" + bet * 2 + "kr");
                    pengar += bet * 2;
                } else if (total[0] == total[1]) {
                    if(printGameStatus) System.out.println("Tie! +" + bet + "kr");
                    pengar += bet;
                } else if (total[1] > 21) {
                    if(printGameStatus) System.out.println("Dealer Busted! +" + bet * 2 + "kr");
                    pengar += bet * 2;
                } else if(printGameStatus) System.out.println("Dealer wins!");
            }

            if (total[2] == 21 && playerFirstCards[0] >= 10 && hasAce[2] != 0) {
                if(printGameStatus) System.out.println("Split has blackjack! +" + (int) (splitBet * 2.5) + "kr");
                pengar += (int) (splitBet * 2.5);
            } else if (total[2] != 0 && total[2] <= 21) {
                if (total[2] > total[1]) {
                    if(printGameStatus) System.out.println("Split wins! +" + splitBet * 2 + "kr");
                    pengar += splitBet * 2;
                } else if (total[2] == total[1]) {
                    if(printGameStatus) System.out.println("Split Tie! +" + splitBet + "kr");
                    pengar += splitBet;
                } else if (total[1] > 21) {
                    if(printGameStatus) System.out.println("Dealer Busted! +" + bet * 2 + "kr");
                    pengar += bet * 2;
                } else if(printGameStatus) System.out.println("Dealer wins over split!");
            }
        }
    }
}